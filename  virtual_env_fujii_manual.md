...
- [Vagrantでの環境構築手順書](#vagrantでの環境構築手順書)
  - [作成者](#作成者)
  - [改訂履歴](#改訂履歴)
  - [このドキュメントの目次](#このドキュメントの目次)
  - [このドキュメントの目的・概要](#このドキュメントの目的概要)
  - [前提条件](#前提条件)
  - [作業完了条件](#作業完了条件)
  - [作業者](#作業者)
  - [チェッカー](#チェッカー)
...
![image](/Users/souryo/Desktop/vagrant_env1.png)

表示が確認できたらOKです。お疲れさまでした。
